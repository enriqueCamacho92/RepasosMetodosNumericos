...
class Unidad4Quiz : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        ...
        if (clickedButton.id ==R.id.btnSubmmitQuiz){
            if(respuestaSeleccionada.equals(Unidad4PreguntasRespuestas.respuestasCorrectas[list[preguntaActualIndice]])){
                score++
                Toast.makeText(this,"Correcto!", Toast.LENGTH_SHORT).show()
            }
            else{
                Toast.makeText(this,"Incorrecto, la respuesta es: "+Unidad4PreguntasRespuestas.respuestasCorrectas[list[preguntaActualIndice]],Toast.LENGTH_SHORT).show()
            }
    ...
    fun cargarNuevaPregunta(){
        ...
        binding.ivPregunta.setBackgroundResource(Unidad4PreguntasRespuestas.preguntas[list[preguntaActualIndice]])
        binding.btnRespuestaA.setText(Unidad4PreguntasRespuestas.opciones[list[preguntaActualIndice]][0])
        binding.btnRespuestaB.setText(Unidad4PreguntasRespuestas.opciones[list[preguntaActualIndice]][1])
        binding.btnRespuestaC.setText(Unidad4PreguntasRespuestas.opciones[list[preguntaActualIndice]][2])
        binding.btnRespuestaD.setText(Unidad4PreguntasRespuestas.opciones[list[preguntaActualIndice]][3])
    }
